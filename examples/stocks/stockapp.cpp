...
void StockApp::updateStocks()
{
    ...
    m_ui->table()->sortRows(day_zero+cur_idx, Qics::Descending, 2, -1, &sortFloats);
}

int StockApp::sortFloats(const QicsDataItem *a, const QicsDataItem *b)
{
    ...
    return QString::compare(a->string(),b->string());
}
